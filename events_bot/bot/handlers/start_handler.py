...
async def cmd_start(message: Message, state: FSMContext, db):
    ...
    await message.answer(
        "👋 Привет! Бот поможет быть в курсе актуальных и интересных мероприятий твоего вуза по выбранным категориям интересов. А еще здесь можно создать и разместить свое мероприятие. Начнем!\n\n"
