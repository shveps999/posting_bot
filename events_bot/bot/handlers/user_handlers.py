...
📮 Актуальные мероприятия - лента событий по заданным интересам и университетам
...
🎓 Изменить университет - смена университетов для получения уведомлений и подборки

Как использовать:

1. Выберите интересующие университеты
